    ...
    <div className="jobs-page">
      ...
      <header className="flex justify-between fixed w-full md:flex-row">
        <div className="nav-logo">
          <Link to="/">
            <img className="p-4" src={whiteLogo} />
          </Link>
        </div>
        <div className="nav-cta justify-around md:flex">
          <a
            ...
            href="https://rhodiumtalent.applytojob.com/apply/TuBqGX39rm/Licensed-Insurance-Agent"
            className="blue-btn hidden secondary border-white">
            Apply Now
          </a>
        </div>
      </header>
      ...
      <div className="hero flex flex-col justify-center content-center items-center align-center w-full h-screen p-6 md:p-10">
        ...
        <div
          ...
          <div className="md:w-4/5 mx-auto">
            <p>
              We are on a mission to help our community protect what matters most and understand exactly how their
      ...
      <div className="main p-10 py-20 second-section">
        <div className="lg:px-10 container mx-auto text-center">
          <div className="3-cols-section md:grid md:grid-cols-3">
            <div className="join-value-points m-8" data-sal="slide-up" data-sal-duration="1000" data-sal-easing="ease">
            ...
            <div
              className="join-value-points m-8"
              data-sal="slide-up"
      ...
      <div className="section-three py-8 px-4 md:py-40 md:px-20">
        <div className="join-team-wrapper lg:w-3/5 m-auto p-6 md:p-10 rounded-2xl">
          <h2 data-sal="slide-up" data-sal-duration="1000" data-sal-easing="ease">
            Everyone deserves to have coverage that fits their needs & goals and understand exactly what they’re paying
            for.
          </h2>
          <p data-sal="slide-up" data-sal-duration="1000" data-sal-easing="ease">
            Most people are far less covered than they think and have little to no understanding of exactly what is
            covered and what is not or how their policy will perform come claim time.
          </p>
          <p data-sal="slide-up" data-sal-duration="1000" data-sal-easing="ease">
            We are on a mission to protect and educate our community. At Ott Insurance Agency it is our job as insurance
            advisors to be the expert, so our clients don’t have to be. We listen to their stories, their goals, and use
            our knowledge of insurance to help them protect and achieve those goals.
          </p>
          <p data-sal="slide-up" data-sal-duration="1000" data-sal-easing="ease">
            We are looking to grow our team with people who believe in that mission and want to be a part of it.
          </p>
          <div className="text-center" data-sal="slide-up" data-sal-duration="1000" data-sal-easing="ease">
            <a
              target="_blank"
              rel="noreferrer nofollower"
              href="https://rhodiumtalent.applytojob.com/apply/TuBqGX39rm/Licensed-Insurance-Agent"
      ...
      <div className="join-team lg:flex py-10">
        ...
        <div className="lg:w-7/12 mx-6 text-center flex flex-col justify-center md:p-6 ">
          <h2>Who We Are</h2>
          <p>
            We started Ott Insurance Agency because we believe our community shouldn’t have to deal with sneaky salesmen
            or becoming an insurance expert just to get the coverage they deserve.
          </p>
          <a
            target="_blank"
            rel="noreferrer nofollower"
